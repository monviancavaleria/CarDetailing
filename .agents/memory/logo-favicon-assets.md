...
- Jul 2026: logo replaced by penguin version (includes tagline "DETAILING · MANTENIMIENTO" and penguin with hose). Served as public/logo-wordmark-v3.webp; plain floodfill left gray haze (visible on tinted bg) — final cut is the hybrid: AI bg removal alpha UNION corner-floodfill alpha (keeps water splash AND speed lines). Old logo-wordmark.webp kept but unused; og:image may still show old logo.
