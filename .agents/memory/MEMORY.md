...
- [WebGL & coche 3D](webgl-3d-cotizador.md) — navegadores del agente sin WebGL (solo se puede probar el fallback); canvas 3D siempre con detección+boundary y carga lazy de three.
