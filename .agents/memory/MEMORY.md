...
- [Coche holográfico del cotizador](webgl-3d-cotizador.md) — 3D WebGL rechazado por el usuario; usar ilustraciones x-ray + halos en % (HoloCarXray). Navegadores del agente sin WebGL.
