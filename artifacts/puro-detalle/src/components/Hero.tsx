        ...
        >
          ...
          <div className="flex flex-col items-center gap-5">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-bubble group relative inline-flex items-center justify-center px-10 py-4 rounded-full overflow-hidden text-[#1D80C3] transition-transform duration-300 active:scale-95 hover:scale-[1.03]"
            >
            ...
            <p className="font-script italic text-2xl md:text-4xl text-[#1D80C3]">
