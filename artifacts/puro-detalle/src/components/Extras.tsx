...
export default function Extras() {
  return (
    <section id="extras" className="py-24 bg-[#111111] border-t border-white/5 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-3xl md:text-5xl font-serif text-white inline-block relative mb-6"
          >
            Extras a la Carta
          ...
          <motion.p 
            ...
            className="text-muted-foreground text-sm md:text-base max-w-2xl mx-auto mt-8 font-light"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {extras.map((extra, i) => (
            <motion.div
              ...
              className="group flex items-center gap-4 p-5 bg-card border border-white/5 border-l-2 border-l-white/10 hover:border-l-primary hover:border-white/10 hover:bg-white/[0.02] transition-all duration-300"
            >
